export const checkboxStyles = {
  ...
  boxWrapper: "relative mt-0.5 inline-flex",
  input: "peer sr-only",
  box: "relative flex items-center justify-center rounded-sm border border-border bg-transparent transition-colors",
  boxState:
    "peer-checked:border-current peer-data-[indeterminate=true]:border-current peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-disabled:border-disabled peer-disabled:bg-disabled",
  icon:
    "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 transition-opacity text-primary peer-disabled:text-on-disabled",
